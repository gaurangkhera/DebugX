...
<header className="bg-white h-24 hidden md:flex">
  ...
  <nav className="hidden xl:contents">
    <ul className="flex items-center mr-4 lg:mr-6 xl:mr-8">
      <li className="p-1">
        <Link to="" className="inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
  ...
  <div className="border flex items-center px-4 lg:px-6 xl:px-8">
    ...
    { user ? <><button onClick={logoutUser} className="bg-black hover:bg-gray-700 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded mr-2">Logout</button></>
     : <><Link to="/login" className="bg-black hover:bg-gray-700 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded mr-2">Login</Link>
    <Link to="/register" className="bg-black hover:bg-gray-700 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded">Register</Link></>}
  </div>
</header></>
  )
}
